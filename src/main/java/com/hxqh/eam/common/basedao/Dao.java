...
public interface Dao<T extends Serializable> {
     ...
     * @param setColoumn
     */
    public abstract void update(T entity, String where, Map<String, ?> params, String setColoumn);
     ...
     * @param where   查询条件语句
     * @param params  查询条件参数
     * @param orderby 排序属性 value asc/desc
     */
     ...
     * 根据条件查询，获得记录集
     *
     * @param firstResult 第一条记录号,为-1时不进行筛选
     * @param maxResult   返回记录最大数,为-1时不进行筛选
     * @param where       查询条件语句
     * @param params      查询条件参数
     * @param orderby     排序属性 value asc/desc
     */
     ...
     * @param where       查询条件语句
     * @param params      查询条件参数
     * @param orderby     order by 属性 asc/desc
