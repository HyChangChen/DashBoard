...
Showbo.Msg={  
    ...
    alert:function(msg){  
      this.show({buttons:{yes:'OK'},msg:msg,title:'message'});
    },  
    confirm:function(msg,fn){  
      //fn为回调函数，参数和show方法的一致  
      this.show({buttons:{yes:'OK',no:'Cancle'},msg:msg,title:'Tip',fn:fn});
    },  
    prompt:function(labelWord,defaultValue,txtId,fn){  
      if(!labelWord)labelWord='Please Input：';
      if(!defaultValue)defaultValue="";  
      if(!txtId)txtId="msg_txtInput";  
      this.show({title:'tips:',msg:labelWord+'<input type="text" id="'+txtId+'" style="width:200px" value="'+defaultValue+'"/>',buttons:{yes:'OK',no:'Cancle'},fn:fn});
    },  
